...
![Multi-app](/images/config-diagrams/multiple-applications.png "0.50")
...
> HTTP-based applications exposed to the outside world. See the [Routing](/configuration/routes.html) section
